 @include('layouts.header')
	...
	<h2><?php echo $title;?></h2>
		<div>
			<h3>The Bees - Info Graphic</h3>
			<p>Honeybees have been present on the Earth for millions of years. One of the oldest agricultural pursuits known to man is beekeeping. Early settlers to North America had a limited and expensive source of sugar, so honeybees were exported from Europe to establish apiaries here.<br>
