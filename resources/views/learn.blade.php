...
<div id="scrollAnchor"><!--anchor for scroll button--></div>
    <div class="row">
      <div id="infographic" class="column small-8 small-centered">
        <img src="img/learn/infographic_holder.svg" alt="Bee infographic">
        <div class="dots"><!--filler for now just to how-->
          <div class="dot"></div>
          <div class="dot"></div>
          <div class="dot"></div>
          <div class="dot"></div>
    ...
    <div class="row">
      <div id="fact" class="column small-8 small-centered">
    ...
    <div id="callToAction" class="row expanded">
      <div class="column small-8 small-centered">
        <p>Check out our <span class="bold">services</span> or <span class="bold">contact us</span> page if you are interested in helping out!</p>
      </div>
    </div>
    ...
    <div class="row">
      <div id="fact" class="column small-8 small-centered">
		...
		<div class="row">
      <div id="blog" class="column small-8 small-centered">
